...
| Channel | Tag | Status |
|---|---|---|
| **npm** — `@agentdeck/setup` | `npm-v*` | 1.3.5 release candidate — Windows console-free autostart, safe supervision probes and e-ink broadcast metrics. Registry delivery is tracked in [#314](https://github.com/puritysb/AgentDeck/issues/314); 1.3.4 remains the verified published version until that readback completes. |
...
| **Elgato Marketplace** — Stream Deck plugin | `streamdeck-v*` | **1.3 published in Maker Console on 2026-09-15** after approval, under the existing publication authorization. Public [Marketplace](https://marketplace.elgato.com/product/agentdeck-dce3806b-176e-40f2-be7d-e029bec0f464) still served 1.2 immediately after publication; public propagation remains to be confirmed ([record](marketplace/elgato/LISTING.md)). |
